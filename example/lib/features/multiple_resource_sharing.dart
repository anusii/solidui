...
demo:sampleData$fileNumber a demo:DemoResource ;
    ...
    demo:description "This is a sample file for demonstrating sharing multiple files sequentially." ;
      ...
      MaterialPageRoute(
        ...
        builder: (navContext) => Theme(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              title: const Text('Multi file sharing'),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: const Text('Start Auto-Demo'),
