...
class _LoadTestState extends State<LoadTest> {
  ...
  List<String> _buildArgs() {
    final args = <String>[
      ...
      '--users', _usersCtrl.text.trim(),
      '--concurrency', _concurrencyCtrl.text.trim(),
      '--resources', _resourcesCtrl.text.trim(),
      '--prefix', _prefixCtrl.text.trim(),
      '--email-domain', _domainCtrl.text.trim(),
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _field(_resourcesCtrl, 'Resources/user', width: 140, number: true),
