...
This exercise will show you how to create a POD on the solid server
hosts https://pods.solidcommunity.au/ and how to use the MyPod app to
create a POD. Note that for workshops there may be other servers set
up for you to experiment with.
